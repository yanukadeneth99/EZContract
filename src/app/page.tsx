...
export default function Home() {
  return (
    <main className="h-screen w-screen flex justify-center items-center bg-transparent">
      <div className="w-5/6 h-3/6 lg:h-5/6 backdrop-blur-xl backdrop-brightness-50 border-black ring-2 ring-[#5C91CE] ring-offset-2 shadow-2xl shadow-[#5C91CE] border-4 rounded-md p-5 flex justify-center items-center flex-col space-y-12">
